...
import { Text, View, Switch, StyleSheet, ScrollView, TouchableOpacity, TouchableHighlight, Linking,Image, Alert,AppState } from 'react-native';
...
constructor() {
  ...
  pickSingleWithCamera(croppings) {
let cropp= false;
    if (croppings === 'true'){
      cropp== true;
    }
